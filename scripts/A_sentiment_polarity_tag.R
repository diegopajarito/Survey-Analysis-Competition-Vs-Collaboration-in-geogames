...
new_tags <- table_tags_sense_joined[is.na(table_tags_sense_joined$sentiment_polarity),]
polarised_tags <- table_tags_sense_joined[!is.na(table_tags_sense_joined$sentiment_polarity),]


# Cloud 1 - All Tags
docs <- Corpus( VectorSource( as.String(table_tags_sense_joined$text_en) ) )
inspect(docs)
